    ...
    public class Musee
    {
        ...
        public void CreerSalle(Salle s)
        {
            if (this.listSalle.Contains(s) == true)
                Console.WriteLine("Cette salle existe déjà !!");
            else
        ...
        public void CreerArtiste(Artiste a)
        {
            if (this.listArtiste.Contains(a) == true)
                Console.WriteLine("Cette artiste existe déjà !!");
            else
        ...
        public void CreerOeuvre(Oeuvre o, Artiste a, Salle s)
        {
            if (this.listOeuvre.Contains(o) == true)
                Console.WriteLine("Cette Oeuvre est déjà présente dans la salle");
            else
            {
        ...
        public void AfficherMusee()
        {
            ...
            {
                this.listArtiste[i].AfficheArtiste();
            }
            aAfficher += "\n\n";
            ...
            for (int i = 0; i < this.listOeuvre.Count; i++)
            {
                this.listOeuvre[i].AffichageOeuvre();
            }
            aAfficher += "\n\n";
            ...
            {
                this.listSalle[i].AfficheOeuvresSalle();
            }
